            ...
            child: Container(
              ...
              child: Stack(
                children: [
                                  ...
                                  child: Column(
                                    children: [
                                      Align(
                                        ...
                                        child: TabBar(
                                          isScrollable: true,
                                          labelColor: const Color(0xFFE6F504),
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-1.21, -0.97),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/logomarca-removebg-preview.png',
                        width: 187.0,
                        height: 131.0,
                        fit: BoxFit.cover,
                      ),
